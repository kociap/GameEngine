...
namespace anton_engine::windowing {
  ...
  void clip_cursor(Window*, Rect<i32> const*);
  ...
  using window_resize_function = void (*)(Window*, f32 width, f32 height,
                                          void* user_data);
  using window_activate_function = void (*)(Window*, bool activated,
                                            void* user_data);
  using cursor_pos_function = void (*)(Window*, f32 x, f32 y, void* user_data);
  // TODO: enum for action?
  // TODO: add mods?
  using mouse_button_function = void (*)(Window*, Key, i32 action,
                                         void* user_data);
  using scroll_function = void (*)(Window*, f32 x_offset, f32 y_offset,
                                   void* user_data);
  ...
  void set_window_resize_callback(Window*, window_resize_function,
                                  void* user_data = nullptr);
  void set_window_activate_callback(Window*, window_activate_function,
                                    void* user_data = nullptr);
  void set_cursor_pos_callback(Window*, cursor_pos_function,
                               void* user_data = nullptr);
  void set_mouse_button_callback(Window*, mouse_button_function,
                                 void* user_data = nullptr);
  ...
  Vec2 get_window_size(Window*);
  Vec2 get_window_pos(Window*);
  void set_window_pos(Window*, Vec2);
  void set_size(Window* window, Vec2 size);
