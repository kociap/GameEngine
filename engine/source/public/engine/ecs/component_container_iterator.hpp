...
namespace anton_engine {
  ...
  public:
    ...
    using iteragor_category = anton::Contiguous_Iterator_Tag;

    Component_Container_Iterator() = delete;
    Component_Container_Iterator(Component_Container_Iterator const&) = default;
    Component_Container_Iterator(Component_Container_Iterator&&) noexcept =
      default;
    ~Component_Container_Iterator() = default;
    Component_Container_Iterator&
    operator=(Component_Container_Iterator const&) = default;
    Component_Container_Iterator&
    operator=(Component_Container_Iterator&&) noexcept = default;
  ...
  private:
    ...
    Component_Container_Iterator(Component* p, difference_type i)
      : data(p), index(i)
    {
    }
  ...
  template<typename Component>
  [[nodiscard]] inline Component_Container_Iterator<Component>
  operator+(Component_Container_Iterator<Component> lhs,
  ...
  template<typename Component>
  [[nodiscard]] inline Component_Container_Iterator<Component>
  operator+(typename Component_Container_Iterator<Component>::difference_type n,
  ...
  operator!=(Component_Container_Iterator<Component> const& lhs,
             Component_Container_Iterator<Component> const& rhs)
  {
    return !(lhs == rhs);
  }
