...
namespace anton_engine {
  ...
  public:
    ...
    struct Construct_Info {
      anton::Fixed_Array<Color_Buffer_Info, max_color_attachments>
        color_buffers;
    ...
    anton::Slice<u32 const> get_color_textures() const;
  ...
  private:
    ...
    Construct_Info info;
    anton::Fixed_Array<u32, max_color_attachments> color_buffers;
  ...
  void bind_framebuffer(Framebuffer const&,
                        Framebuffer::Bind_Mode = Framebuffer::read_draw);
  void bind_framebuffer(Framebuffer const*,
                        Framebuffer::Bind_Mode = Framebuffer::read_draw);
