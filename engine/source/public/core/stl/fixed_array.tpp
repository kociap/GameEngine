...
namespace anton_engine::anton_stl {
    ...
    template <typename T, i64 Capacity>
    void serialize(serialization::Binary_Output_Archive& out, anton_stl::Fixed_Array<T, Capacity> const& array) {
        using size_type = typename anton_stl::Fixed_Array<T, Capacity>::size_type;
    ...
    template <typename T, i64 Capacity>
    void deserialize(serialization::Binary_Input_Archive& in, anton_stl::Fixed_Array<T, Capacity>& array) {
        using size_type = typename anton_stl::Fixed_Array<T, Capacity>::size_type;
        ...
        if constexpr (std::is_default_constructible_v<T>) {
            ...
            try {
                ...
                anton_stl::destruct_n(array.data(), size);
                throw;
            }
        } else {
            size_type n = size;
            try {
                ...
                // TODO move stream backward to maintain weak guarantee
                anton_stl::destruct_n(array.data(), size - n);
                throw;
            }
        }
    }
