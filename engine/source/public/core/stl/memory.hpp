...
#include <core/stl/detail/memory_common.hpp>
...
namespace anton_engine::anton_stl {
    ...
    //
    // Example usage:
    //   anton_stl::copy_backward(array.begin(), array.end(), dest_array.end());
    //
    ...
    inline Dest_Bidirectional_Iterator copy_backward(Bidirectional_Iterator first, Bidirectional_Iterator last, Dest_Bidirectional_Iterator dest) {
        // TODO: Iterator unwrapping
        using input_iterator_cat = typename anton_stl::Iterator_Traits<Bidirectional_Iterator>::iterator_category;
        using output_iterator_cat = typename anton_stl::Iterator_Traits<Dest_Bidirectional_Iterator>::iterator_category;
        using input_value_type = typename anton_stl::Iterator_Traits<Bidirectional_Iterator>::value_type;
        using output_value_type = typename anton_stl::Iterator_Traits<Dest_Bidirectional_Iterator>::value_type;
    ...
    //
    // Example usage:
    //   anton_stl::move_backward(array.begin(), array.end(), dest_array.end());
    //
    // Reference implementation:
    //   template<typename Bidirectional_Iterator>
