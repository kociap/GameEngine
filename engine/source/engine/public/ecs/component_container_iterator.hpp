#ifndef CORE_ECS_COMPONENT_CONTAINER_ITERATOR_HPP_INCLUDE
#define CORE_ECS_COMPONENT_CONTAINER_ITERATOR_HPP_INCLUDE
...
#endif // !CORE_ECS_COMPONENT_CONTAINER_ITERATOR_HPP_INCLUDE
