...
namespace anton_engine {
  ...
  {
    return k == Key::gamepad_right_stick_x_axis |
           k == Key::gamepad_right_stick_y_axis |
           k == Key::gamepad_left_stick_x_axis |
  ...
  anton::String_View key_to_string(Key);
  Key key_from_string(anton::String_View);
} // namespace anton_engine
