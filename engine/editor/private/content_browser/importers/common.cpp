...
namespace anton_engine::importers {
  ...
  {
    return static_cast<u64>(stream[0]) | (static_cast<u64>(stream[1]) << 8) |
           (static_cast<u64>(stream[2]) << 16) |
           (static_cast<u64>(stream[3]) << 24) |
           (static_cast<u64>(stream[4]) << 32) |
           (static_cast<u64>(stream[5]) << 40) |
           (static_cast<u64>(stream[6]) << 48) |
           (static_cast<u64>(stream[7]) << 56);
  }
