...
namespace anton_engine {
    ...
    void load_default_editor_preferences() {
        ...
        editor_preferences.gizmo_settings.axis_x_color = {179.f / 255.f, 20.f / 255.f, 5.f / 255.f, 0.7f};
        editor_preferences.gizmo_settings.axis_y_color = {0, 220.0f / 255.0f, 0, 0.7f};
        editor_preferences.gizmo_settings.axis_z_color = {15.f / 255.f, 77.f / 255.f, 186.f / 255.f, 0.7f};
