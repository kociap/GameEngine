...
namespace anton_engine {
    ...
    static void serach_for_components(std::string_view directory, atl::Array<Component>& out) {
...
int main(int argc, char** argv) {
    ...
    atl::Array<Component> components;
    ...
    generated_file << '\n'
                   << "namespace anton_engine {\n"
                   << indent(1) << "atl::Array<Component_Serialization_Funcs>& get_component_serialization_functions() {\n"
                   << indent(2) << "static atl::Array<Component_Serialization_Funcs> serialization_funcs{atl::variadic_construct,\n";
